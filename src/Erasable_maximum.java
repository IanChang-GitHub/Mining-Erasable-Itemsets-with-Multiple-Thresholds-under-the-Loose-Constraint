...
public class Erasable_maximum 
{
    ...
    static	long memory; 		//宣告未使用前記憶體狀況與使用後記憶體狀況，兩者相減就是使用記憶體量！
	...
	*/
	...
	public static void main(String[] args)
    {
        ...
        {	
			...
			//r.gc();
			System.out.println("Erasable Itemset Mining Algorithm with maximum constraint");
 			System.out.println("=====================================");
			...
			System.out.println(" ");
			System.out.println(" Maximum Gain Threshold: ");
			System.out.print(" ");
			for(int i=0;i<minGain.length;i++)
			...
			System.out.println("-------------------------------------------------------------");
			System.out.println();
			System.out.println(" Mining Erasable Itemsets on original method maximum 在記憶體te方面，共使用: "+usedStr); 
